...
<header class="header">
    <div class="conteinar-fluid navegador">
        <div class=" row">
            ...
            <div class="col">
                <a class="btn" href="cadProduto.php">Produtos</a>
            </div>
        </div>
    </div>
</header>
            ...
            <div class="col">
                <div class="box">
                    <form action="../models/cliente.php" method="post">
                        <div class="row">
                            <h4 class="text-center p-2 my-1">Tela de Clientes</h4>
                        </div>
                        <div class="row">
                            <div class="col">
                                <label>Nome</label>
                                <input type="text" name="inputTextNome" id="inputTextNome" class="form-control" required>
                            </div>
                            <div class="col">
                                <label>Endereço</label>
                                <input type="text" name="inputTextEnderoco" id="inputTextEnderoco" class="form-control" required>
                            </div>
                            <div class="col">
                                <label>Bairro</label>
                                <input type="text" name="inputTextBairro" id="inputTextBairro" class="form-control" required>
                            </div>
                            <div class="col">
                                <label>Cidade</label>
                                <input type="text" name="inputTextCidade" id="inputTextCidade" class="form-control" required>
                            </div>
                            <div class="row">
                                <div class="col"></div>
                                <div class="col-sm-2">
